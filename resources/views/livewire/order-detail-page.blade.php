        ...
        <div class="md:w-3/4">
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                <table class="w-full">
                    <thead>
                        <tr>
                            <th class="text-left font-semibold">STT</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($order_items as $key => $item)
                            <tr wire:key="{{ $key + 1 }}">
                                ...
                                <td class="py-4"><span class="font-semibold">{{ $item->product->name }}</span></td>
                                <td class="py-4">
                                ...
                                <td class="py-4">{{ Number::currency($item->product->price, 'VND') }}</td>
                                <td class="py-4">
                                    <span class="text-center w-8">{{ $item->quantity }}</span>
                                </td>
                                <td class="py-4">
                                    {{ Number::currency($item->product->price * $item->quantity, 'VND') }}</td>
                            </tr>
                        @endforeach
                        <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span> {{ Number::currency($order->grand_total, 'VND') }}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">{{ Number::currency($order->grand_total, 'VND') }}</span>
                </div>

            </div>
            <div class="flex items-end justify-end mt-[16px] mb-2 cursor-pointer">
                ...
                <span wire:click = 'handleExport'class="font-semibold">Export</span>
            </div>
        </div>
    </div>
</div>
