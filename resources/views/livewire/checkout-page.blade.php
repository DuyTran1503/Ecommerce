<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <form action="" wire:submit.prevent='handleClick'>
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                ...
                <button type="submit"
                    ...
                    <span wire:loading>Proceessing...</span>
                </button>
                            ...
                            <li class="py-3 sm:py-4" wire:key='{{ $item['product_id'] }}'>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="Neil image" class="w-[4.3rem] h-16 rounded-full"
                                    ...
                                    <div
                                        ...
                                        {{ Number::currency($item['unit_amount'], 'VND') }}
                                    </div>
                                </div>
                            </li>
                        @endforeach
